...
**Agent OS 의 선택**: **로컬 우선 + 작은 모델 + 똑똑한 orchestration**.  
= 능력 격차를 **시스템 설계로 보완**.
...
└───────────────┬───────────────────────────────────────┘
                ↓ 자연어 명령
┌───────────────────────────────────────────────────────┐
│   Agent OS (Anti-Gravity · VS Code Extension)         │
├───────────────────────────────────────────────────────┤
...
| 기능 | ChatGPT Plus | Claude Code | **Agent OS** |
|---|---|---|---|
| 가격 | $20/월 | $200/월 | **무료** |
| 로컬 LLM | ❌ | ❌ | ✅ |
| 오프라인 | ❌ | ❌ | ✅ |
